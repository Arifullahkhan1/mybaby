...
function h5c_files_admin($hook_suffix) {
    ...
    if ( $hook_suffix == 'settings_page_html5-cumulus' ) {
        ...
        wp_register_script('h5c-script', $purl . '/inc/h5c-script.js', array(), '1.00');  
        wp_enqueue_script('h5c-script');
        wp_register_style('h5c-css', $purl . '/inc/h5c-css.css', array(), '1.00');
...
<div class="wrap">
<h2><?php _e('&#8220;HTML5 Cumulus&#8221; Settings', 'html5-cumulus'); ?></h2>
...
<div class="postbox">
    ...
    <div class="inside" style="display: block;margin-right: 12px;">
        ...
        Быстро, качественно и дешево. Прайс-лист смотрите по адресу <a target="new" href="https://www.wpuslugi.ru/?from=h5c-plugin">https://www.wpuslugi.ru/</a>.</p>
        <div style="clear:both;"></div>
    </div>
</div>
<?php } else { ?>
<div class="postbox">
    <h3 style="border-bottom: 1px solid #EEE;background: #f7f7f7;"><span class="tcode"><?php _e('Do you like this plugin ?', 'html5-cumulus'); ?></span></h3>
    <div class="inside" style="display: block;margin-right: 12px;">
        <img src="<?php echo $purl . '/img/icon_coffee.png'; ?>" title="<?php _e('buy me a coffee', 'html5-cumulus'); ?>" style=" margin: 5px; float:left;" />
        <p><?php _e('Hi! I\'m <strong>Flector</strong>, developer of this plugin.', 'html5-cumulus'); ?></p>
        <p><?php _e('I\'ve spent many hours developing this plugin.', 'html5-cumulus'); ?> <br />
		<?php _e('If you like and use this plugin, you can <strong>buy me a cup of coffee</strong>.', 'html5-cumulus'); ?></p>
        <a target="new" href="https://www.paypal.me/flector"><img alt="" src="<?php echo $purl . '/img/donate.gif'; ?>" title="<?php _e('Donate with PayPal', 'html5-cumulus'); ?>" /></a>
        <div style="clear:both;"></div>
    </div>
</div>
<?php } ?>
...
<div class="postbox">
    ...
    <h3 style="border-bottom: 1px solid #EEE;background: #f7f7f7;"><span class="tcode"><?php _e('Options', 'html5-cumulus'); ?></span></h3>
    <div class="inside" style="display: block;">
        ...
        <table class="form-table">
            ...
            <tr class="outlinetr" style="display:none;">
                <th><?php _e('outlineOffset:', 'html5-cumulus'); ?></th>
                <td>
                    <input style="max-width: 50px;" type="number" name="outlineOffset" min="0" max="15" step="1" value="<?php echo $h5c_options['outlineOffset']; ?>" />
            ...
            <tr class="outlinetr" style="display:none;">
                ...
                <td>
                    <input style="max-width: 50px;" type="number" name="outlineRadius" min="0" max="20" step="1" value="<?php echo $h5c_options['outlineRadius']; ?>" />
            ...
            <tr class="outlinetr" style="display:none;">
                ...
                <td>
                    <input style="max-width: 50px;" type="number" name="outlineThickness" min="0" max="10" step="1" value="<?php echo $h5c_options['outlineThickness']; ?>" />
...
<div class="postbox" style="margin-bottom:0;">
    <h3 style="border-bottom: 1px solid #EEE;background: #f7f7f7;"><span class="tcode"><?php _e('About', 'html5-cumulus'); ?></span></h3>
	  <div class="inside" style="padding-bottom:15px;display: block;">
     
      <p><?php _e('If you liked my plugin, please <a target="new" href="https://wordpress.org/plugins/html5-cumulus/"><strong>rate</strong></a> it.', 'html5-cumulus'); ?></p>
      ...
      <div class="about">
        <ul>
            ...
            <?php endif; ?>
            <li><a target="new" href="https://wordpress.org/plugins/bbspoiler/">BBSpoiler</a> - <?php _e('this plugin allows you to hide text using the tags [spoiler]your text[/spoiler].', 'html5-cumulus'); ?></li>
            <li><a target="new" href="https://wordpress.org/plugins/easy-textillate/">Easy Textillate</a> - <?php _e('very beautiful text animations (shortcodes in posts and widgets or PHP code in theme files).', 'html5-cumulus'); ?> </li>
            <li><a target="new" href="https://wordpress.org/plugins/cool-image-share/">Cool Image Share</a> - <?php _e('this plugin adds social sharing icons to each image in your posts.', 'html5-cumulus'); ?> </li>
            <li><a target="new" href="https://wordpress.org/plugins/today-yesterday-dates/">Today-Yesterday Dates</a> - <?php _e('this plugin changes the creation dates of posts to relative dates.', 'html5-cumulus'); ?> </li>
            <li><a target="new" href="https://wordpress.org/plugins/truncate-comments/">Truncate Comments</a> - <?php _e('this plugin uses Javascript to hide long comments (Amazon-style comments).', 'html5-cumulus'); ?> </li>
            <li><a target="new" href="https://wordpress.org/plugins/easy-yandex-share/">Easy Yandex Share</a> - <?php _e('share buttons for WordPress from Yandex. ', 'html5-cumulus'); ?> </li>
