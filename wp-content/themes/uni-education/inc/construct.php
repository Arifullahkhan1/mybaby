...
if ( ! function_exists( 'uni_education_site_info' ) ) :
	...
	function uni_education_site_info() { 
		$copyright = "Copyright &copy; ".  date('Y')." | All Rights Reserved";//uni_education_theme_option('copyright_text');
		$poweredby = sprintf( esc_html__( 'Thanks for visiting', 'uni-education' ), '<a href="' . esc_url( 'http://sharkthemes.com/' ) . '" target="_blank">','</a>' );
		?>
		<div class="site-info">
            <div class="wrapper">
